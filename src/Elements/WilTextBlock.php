...
class WilTextBlock extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'btn-class',
            [
                'label' => __('Button Class', 'hslanding-elementor'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => 'border-btn border-btn6'
            ]
        );
        $this->add_control(
            'img',
                ...
                <div class="col-lg-6 order-lg-2">
                    <div class="con-cloud-about-content rmb-50">
                        <div class="con-cloud-section-title mb-35">
                            <span class="" style="font-weight: 700; font-size: 14px; color: #6563f7; display: flex; align-items: center; margin-bottom: 10px;">
                        ...
                        <a target="_blank" rel="noopener noreferrer" href="<?php echo esc_html($aSettings['btn-href']); ?>" class="<?php echo esc_html($aSettings['btn-class']); ?>" >
                            <?php echo esc_html($aSettings['btn']); ?>
                        </a> 
                    </div>
                </div>
                <div class="col-lg-6">
